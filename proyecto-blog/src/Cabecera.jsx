...
<a className="navbar-brand fw-bold text-white" href="/app">Un blog genérico</a>
...
<span className="mb-0 d-flex">
  ...
  <span className="text-white m-2"> {localStorage.getItem("user")}</span>
  <img
  ...
  <ul className="dropdown-menu fondo1">
    ...
    <li className="text-center m-2"><span className="fw-light p-3">{localStorage.getItem("email")}</span></li>
    <li className="text-center">      <button className="btn btn-danger" onClick={() => Cerrarsesion()}>
                    Cerrar sesión
                  </button></li>
  </ul>
</div>
